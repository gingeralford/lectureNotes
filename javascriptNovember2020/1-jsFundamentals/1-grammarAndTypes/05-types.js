...
//Undefined
/*
Undefined usually means a variable has been declared but it's not be assigned a value
*/
...
//Null
/*
Null means a variable as been declared and assigned a value of null
*/
var empty = null;
console.log(empty);

/*
Null and undefined both represent variables with no value inside. Think of it this way--null values are for gag gifts that are boxes intentionally given with nothing inside (because that's the gag). Undefined values are gifts given when the person forgot to put the value inside (oops!).
*/
...
Denoted by {}
Have keys and values--color (key): 'blue' (value), separated with a colon, each key is separated with a comma
*/
